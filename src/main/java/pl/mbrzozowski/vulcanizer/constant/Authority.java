...
import static pl.mbrzozowski.vulcanizer.enums.Authorities.SUPER_ADMIN;
...
public class Authority {
    ...
    public static final Set<String> SUPER_ADMIN_AUTHORITIES = new
            HashSet<>(List.of(USER.getAuthority(), SUPER_ADMIN.getAuthority()));
